...
{
	PrintString("\n\t\t\t-----Cac thanh vien nhom-----\n");
	PrintString("\t\tNguyen Thi Ngoc Mai - 19120287\n");
	PrintString("\t\tDoan Thu Ngan - 19120302\n");
	PrintString("\t\tDinh Huynh Tien Phu - 19120325\n");
	PrintString("\t\tNguyen Cong Nhat Tung - 19120421\n");
	PrintString("\t\tNguyen Quang An - 19120445\n");
	PrintString("----------------------------------------\n");

	PrintString("\n\t\t\t-----Chuong trinh sort-----\n");
	PrintString("\t\t-Tao mang gom 1 -> 100 phan tu\n");
	PrintString("\t\t-Moi nguoi dung nhap so phan tu va lan luot nhap cac phan tu\n");
	PrintString("\t\t-Hien thi lai thong tin ma nguoi dung vua nhap\n");
